# azurelocal-vms — Claude Code Context
...
- `azurelocal-vms-engineer` (model: sonnet) — Expert in `azurelocal-vms`: deep knowledge of this repo's structure, conventions, and development workflow.
